  ...
  Widget _buildForState(PlaybackController playback) {
    return ValueListenableBuilder<PlaybackState>(
      ...
      builder: (context, state, _) {
        ...
        if (!state.hasTrack || state.isEventTrack) {
                ...
                children: [
                  ...
                  Center(
                    child: ConstrainedBox(
                      ...
                      child: AspectRatio(
                        aspectRatio: 1,
                        child: _Artwork(url: state.artworkUrl, size: 250),
                      ),
                    ),
                  ),
                  ...
                  Slider(
                    ...
                    onChanged:
                        state.isEventTrack || state.duration == Duration.zero
                        ? null
                        : (value) => playback.seek(
                            Duration(
                              milliseconds:
