...
class _MusicPreferencesScreenState extends State<MusicPreferencesScreen> {
  ...
  void initState() {
    ...
    _selectedArtist = widget.profile.favoriteArtist.isEmpty
        ? null
        : widget.profile.favoriteArtist;
                ...
                child: ListView(
                  ...
                  children: [
                    ...
                    if (_error != null) ...[
                      ...
                      Text(
                        _error!,
                        style: const TextStyle(color: _PrefsColors.error),
                      ),
                    ],
                      ...
                      child: DecoratedBox(
                        decoration: BoxDecoration(
                          ...
                          gradient: const LinearGradient(
                            colors: [
                              _PrefsColors.gradientStart,
                              _PrefsColors.gradientEnd,
                            ],
                          ),
                        ),
